    ...
    IEnvironmentVariableViewModel<EnvironmentVariableListItem>
{
    ...
    [ObservableProperty]  // 会生成属性 EnvironmentVariables
    public ObservableCollection<EnvironmentVariableListItem>? _environmentVariables;
    ...
    private readonly List<EnvironmentVariableListItem> removed = new();
}
