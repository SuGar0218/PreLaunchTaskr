...
public partial class App : Application
{
    ...
    public static string BaseUri { get; } = Path.GetFullPath(".");
    ...
    {
        Configurator = Configurator.Init(Properties.SettingsLocation, Properties.LauncherNet8Location);
        Launcher = Launcher.Init(BaseUri);
